-- Reconciliation bridge for the already-deployed project.
-- Fresh installs already receive invoke_edge_function from 0003; this idempotently normalizes existing installs.
