...
values
  ('mt5_broker_xauusd', 'broker', 'XAUUSD', 1, 'Canonical execution and broker-price history once MT5 access is authorized', '1m/tick', null, true, true, '{"status":"pending_broker_access"}'::jsonb),
...
-- Deliberately no anon/authenticated policies. Server-side service role only.
